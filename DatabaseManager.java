 ...
 * All database manipulation will be done through this class.
 *
 * @author Armand le Roux
 * @version 1.10, 08 May 2022
 */
public class DatabaseManager {
   ...
   * @throws SQLException Failed to sign in. Username or password incorrect.
   */
   ...
   * in the database and return it in a list.
   *
   * @return projectList List of retrieved projects,
   */
  public List<Project> retrieveProjects() {
    ...
    /* For each project retrieve Person information from
  ...
  /**
   *
   * This method adds a new project to the projects table in
   * the database.
   *
   * @param number Project number
   * @param name Project name
   * @param buildingType Project building type
   * @param Address Project address
   * @param totalFees Project total fees
   * @param paidToDate Project total paid to date
   * @param deadline Project deadline
   * @param completionDate Project completion date
   * @param contractor Project contractor name
   * @param architect Project architect name
   * @param customer Project Customer name
   */
  ...
  /**
   *
   * This method allow you to update string values of a
   * project(identified by number) in the projects table.
   *
   * @param number Number of project to edit
   * @param column Column off value to change
   * @param newValue New value to set column to
   */
  ...
  /**
   *
   * This method allow you to update float values of a
   * project(identified by number) in the projects table.
   *
   * @param number Number of project to edit
   * @param column Column off value to change
  ...
  /**
   *
   * This method updates a Person objects name in its
   * respective table in the database.
   *
   * @param table Table to edit
   * @param name Name to fine in table
   * @param person person object being edited
   * @param newValue new value to set name to
   */
   ...
   * @param telNum name of Contractor
   * @param email name of Contractor
   * @param physicalAddress name of Contractor
   */
   ...
   * @param telNum name of Architect
   * @param email name of Architect
   * @param physicalAddress name of Architect
   */
   ...
   * @param telNum name of Customer
   * @param email name of Customer
   * @param physicalAddress name of Customer
   */
